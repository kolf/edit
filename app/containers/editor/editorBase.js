...
@connect(select)
export default class EditorBaseContainer extends Component {
    ...
    render() {
        const self = this;
        const {crumbs, alert, typeDoc, filterParams, dataFilter, doing, selectStatus, maskLoading, listData} = this.state;
        const {pageId, pageType, showSearchBar} = this.props;
