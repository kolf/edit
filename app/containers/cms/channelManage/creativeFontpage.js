...
export default class CreativeFontpage extends Component {
        ...
        <Tabs type="card" onChange={this.tabChange.bind(this)} activeKey={activedTab}>
          <Tabpane tab="焦点图设置" key="1">
            <FocusPic {...picListData} tipMessage={{isSame: 1, message: ["请上传最小尺寸为2000/660的图"]}}
                      deleteData={this.deleteData.bind(this)} onUpdateData={this.updateData.bind(this, 2000, 660)}
                      addData={this.addData.bind(this)} sortAble={true}/>
          </Tabpane>
          <Tabpane tab="热点活动" key="4">
            <FocusPic {...picListData} tipMessage={{isSame: 1, message: ["请上传最小尺寸为390/180的图"]}}
                      deleteData={this.deleteData.bind(this)} onUpdateData={this.updateData.bind(this, 390, 180)}
                      addData={this.addData.bind(this)} sortAble={true}/>
          </Tabpane>
  ...
  changePics(index, field, value, type, width, height) {
    ...
    if (this.expanded) {
      ...
      if (type == 1) {
        ReactDOM.render(
          <FocusPic {...this.state.picListData} tipMessage={{isSame: 0, message: this.state.tipArr}}
                    onUpdateData={this.updateDataRecemened.bind(this, width, height)}/>,
          container
        );
      }
      else {
        ...
        ReactDOM.render(
          <FocusPic {...this.state.picListData} tipMessage={{isSame: 1, message: [tip]}}
                    onUpdateData={this.updateData.bind(this, width, height)}/>,
          container
        );
      }
